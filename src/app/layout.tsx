...
export const metadata: Metadata = {
  title: "AIVA — The AI Executive Assistant",
  description:
    "Connect Gmail, Slack, and Shopify. AIVA prioritizes what matters, drafts replies in your tone, and auto-sends the routine — so nothing important slips through.",
